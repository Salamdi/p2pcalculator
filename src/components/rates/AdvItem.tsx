...
export function AdvItem({
  ...
  return (
    ...
    >
      <span>{item.adv.price} {item.adv.fiatSymbol}</span>
      <Button
        className={cn(styles.button, "disabled:bg-blue-500/50 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-lg transition-colors")}
        onClick={(e) => {
            e.stopPropagation();
